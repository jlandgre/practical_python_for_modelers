...
class RollLength:
    def __init__(self, df_raw=None, diam_roll=None, diam_core=None, caliper=None, IsTest=False):
        ...
        ### Initialize attributes for all __init__ arguments
        ...
        ### Initialize all "internal" attributes to help curate
        #Raw data fit attributes
        self.slope = None # length:diam_m**2 slope [1/m]
        self.intercept = None #length units [m]
        self.R_squared = None


    def xxxx_AddCalculatedRawCols(self):
        """
        Add Calculated columns to length, diam raw measurement data
        """

        """
        Add two columns to self.df_raw:
        'diam_m' = diam'/1000 to convert mm to m
        'diam_m^2 = 'diam_m **2
        """
    ...
    """
    =========================================================================
    Completed functions from roll.py below here. We will discuss as
    examples
    """
    ...
    def CaliperFromRawData(self):
        """
        Procedure to calculate caliper from length by diam df_raw data
        Usage:
