...
scripts_dir = os.sep.join(os.path.dirname(current_dir).split(os.sep)[:-1])
scripts_dir = scripts_dir + os.sep + 'roll_scripts'
if not scripts_dir in sys.path: sys.path.append(scripts_dir)
from roll2 import RollLength
